...
export const timeline: TimelineEntry[] = [
  ...
  },
  {
    ...
    description: {
      pt: 'Curso em andamento com foco em desenvolvimento de software, arquitetura de sistemas e banco de dados.',
      en: 'Ongoing degree focused on software development, system architecture, and databases.',
    },
  },
  {
    year: '2024',
